 ...
 * Sanity), así que viven en variables públicas. El token de escritura sí lo es: sólo se
 * usa en el script de migración, se lee de `.env.local` y nunca llega al navegador.
 */
