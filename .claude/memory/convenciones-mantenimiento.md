...
description: Regla del usuario — actualizar memorias, changelog y CLAUDE.md automáticamente en cada cambio, todo a nivel de proyecto
metadata:
  type: feedback
---
...
colaboren con contexto coherente y siempre al día; que el contexto quede desfasado rompe ese
objetivo.
...
reflejarse en la rama `claude`. Esa sincronización respeta [[politica-commits]] (Claude propone
commit/push en inglés; el usuario ejecuta) y el flujo de [[flujo-git-y-ramas]]. Nunca subir
secretos: [[seguridad-secretos]].
